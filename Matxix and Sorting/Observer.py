...
def Sammle_Datei():
    ...
    for Data1 in Roh_Daten:
        ...
        if faktor == False:
            Echte_Daten.append(
                    str(Axe1[0] + " " + Axe1[1] + " " + str(Abstand1)))
            print(str(Axe1[0] + " " + Axe1[1] + " " + str(Abstand1)))
...
def Messen(Punkt_Data):
    ...
    for Data in Punkt_Data:
        ...
        x_list.append(X)
        y_list.append(Y)
        z_list.append(vz + 250)
        Daten_list.append(str(X) + ', ' + str(Y) + ', ' + str(int(vz) + 250) + '\n')
        print(str(X) + ', ' + str(Y) + ', ' + str(int(vz) + 250) + '\n')
    x_list.append(450)
    y_list.append(450)
    z_list.append(0)
